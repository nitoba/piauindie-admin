...
var courseSchema = (0, import_core.list)({
  ...
  fields: {
    ...
    enrolledOn: (0, import_fields.relationship)({
      ref: 'Enrollment.course',
      many: true,
      ui: { createView: { fieldMode: 'hidden' } },
    }),
    lessons: (0, import_fields.relationship)({
      ref: 'Lesson.course',
      many: true,
    }),
    teacher: (0, import_fields.relationship)({ ref: 'User.teachingIn' }),
    courseEvaluation: (0, import_fields.select)({
      type: 'integer',
      options: [
        { label: '1', value: 1 },
        { label: '2', value: 2 },
  ...
  hooks: {
    validateInput(_0) {
      return __async(
        this,
        arguments,
        function* ({ inputData: { student, course }, context: { prisma } }) {
...
var userSchema = (0, import_core4.list)({
  ...
  fields: {
    ...
    enrollments: (0, import_fields4.relationship)({
      ref: 'Enrollment.student',
      many: true,
    }),
    teachingIn: (0, import_fields4.relationship)({
      ref: 'Course.teacher',
      many: true,
    }),
